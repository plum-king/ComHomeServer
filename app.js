...
const getBtn = (user) => {
  return user !== undefined
    ? `${user.name} | <a href="/auth/logout">logout</a> <br><br> <a href = "/extra_review_list">대외활동 후기 바로가기</a> <br><br> <a href = "/job_review_list">취업 후기 바로가기</a> <br><br> <a href = "/edu_contest_list">교육/공모전 글 바로가기</a>`
...
//교육/공모전 글
app.get("/edu_contest_list", require("./routes/edu_contest_list"));
app.get("/edu_contest_write", require("./routes/edu_contest"));
app.post("/edu_contest_write", require("./routes/edu_contest"));
app.get(
  "/edu_contest_detail/:edu_contest_no",
  require("./routes/edu_contest_detail")
);
//교육/공모전 댓글
